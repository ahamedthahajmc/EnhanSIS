...
function DeletePrompt_sys_maintain($title, $action = 'delete') {
    ...
    if (!$_REQUEST['delete_ok'] && !$_REQUEST['delete_cancel']) {
        ...
        echo "<CENTER><h4>"._areYouSureYouWantTo." $action that $title?</h4><br><FORM action=$PHP_tmp_SELF&delete_ok=1 METHOD=POST><INPUT type=submit class=\"btn btn-danger\" value="._ok.">&nbsp;<INPUT type=button class=\"btn btn-primary\" name=delete_cancel value="._cancel." onclick='window.location=\"Modules.php?modname=institutesetup/SystemPreference.php&page_display=MAINTENANCE\"'></FORM></CENTER>";
        PopTable('footer');
        return false;
    } else
        return true;
...
function DeletePrompt_Portal($title, $action = 'delete') {
    ...
    if (!$_REQUEST['delete_ok'] && !$_REQUEST['delete_cancel']) {
        echo '<BR>';
        PopTable('header', _confirm ." ". (strpos($action, ' ') === false ? ' ' . ucwords($action) : ''));
        echo "<CENTER><h4>"._areYouSureYouWantTo." $action that $title?</h4><br><FORM action=$PHP_tmp_SELF&delete_ok=1 METHOD=POST><INPUT type=submit class=\"btn btn-danger\" value="._ok.">&nbsp;<INPUT type=button class=\"btn btn-primary\" name=delete_cancel value="._cancel." onclick='window.location=\"Modules.php?modname=institutesetup/PortalNotes.php\"'></FORM></CENTER>";
        PopTable('footer');
        return false;
    } else
        return true;
...
function DeletePrompt_Period($title, $action = 'delete') {
    ...
    if (!$_REQUEST['delete_ok'] && !$_REQUEST['delete_cancel']) {
        echo '<BR>';
        PopTable('header', _confirm ." ". (strpos($action, ' ') === false ? ' ' . ucwords($action) : ''));
        echo "<CENTER><h4>"._areYouSureYouWantTo." $action that $title?</h4><br><FORM action=$PHP_tmp_SELF&delete_ok=1 METHOD=POST><INPUT type=submit class=\"btn btn-danger\" value="._ok.">&nbsp;<INPUT type=button class=\"btn btn-primary\" name=delete_cancel value="._cancel." onclick='window.location=\"Modules.php?modname=institutesetup/Periods.php\"'></FORM></CENTER>";
        PopTable('footer');
        return false;
    } else
        return true;
...
function DeletePrompt_GradeLevel($title, $action = 'delete') {
    ...
    if (!$_REQUEST['delete_ok'] && !$_REQUEST['delete_cancel']) {
        echo '<BR>';
        PopTable('header', _confirm ." ". (strpos($action, ' ') === false ? ' ' . ucwords($action) : ''));
        echo "<CENTER><h4>"._areYouSureYouWantTo." $action that $title?</h4><br><FORM action=$PHP_tmp_SELF&delete_ok=1 METHOD=POST><INPUT type=submit class=\"btn btn-danger\" value="._ok.">&nbsp;<INPUT type=button class=\"btn btn-primary\" name=delete_cancel value="._cancel." onclick='window.location=\"Modules.php?modname=institutesetup/GradeLevels.php\"'></FORM></CENTER>";
        PopTable('footer');
        return false;
    } else
        return true;
...
function DeletePrompt_Sections($title, $action = 'delete') {
    ...
    if (!$_REQUEST['delete_ok'] && !$_REQUEST['delete_cancel']) {
        echo '<BR>';
        PopTable('header', _confirm ." ". (strpos($action, ' ') === false ? ' ' . ucwords($action) : ''));
        echo "<CENTER><h4>"._areYouSureYouWantTo." $action that $title?</h4><br><FORM action=$PHP_tmp_SELF&delete_ok=1 METHOD=POST><INPUT type=submit class=\"btn btn-danger\" value="._ok.">&nbsp;<INPUT type=button class=\"btn btn-primary\" name=delete_cancel value="._cancel." onclick='window.location=\"Modules.php?modname=institutesetup/Sections.php\"'></FORM></CENTER>";
        PopTable('footer');
        return false;
    } else
        return true;
