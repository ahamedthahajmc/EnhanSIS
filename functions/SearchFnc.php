    ...
    switch ($type) {
            ...
            if ($_REQUEST['student_id']) {
                if ($_REQUEST['student_id'] != 'new') {
                    ...
                    if ($_REQUEST['institute_id'])
                        $_SESSION['UserInstitute'] = $_REQUEST['institute_id'];
                } else
                    unset($_SESSION['student_id']);
        ...
        case 'general_info':
            ...
            case 'search_fees':
                echo '<div class="row">';
                echo '<div class="col-md-6">';
                echo '<div class="form-group"><label class="control-label text-right col-lg-4">' . _studentId . '</label><div class="col-lg-8"><input type="text" size=30 placeholder="' . _studentId . '" class="form-control" id= "student_id_input" ></div></div>';    
                echo '</div>'; //.col-md-6
                echo '</div>'; //.row
            
                echo '<div class="row">';
                echo '<div class="col-md-6">';
                echo '<div class="form-group"><label class="control-label text-right col-lg-4">' . _firstName . '</label><div class="col-lg-8"><input type="text"  size=30 placeholder="' . _firstName . '" class="form-control" id="first_name_input" ></div></div>';

                echo '</div><div class="col-md-6">';
                echo '<div class="form-group"><label class="control-label text-right col-lg-4">' . _lastName . '</label><div class="col-lg-8"><input type="text"  size=30 placeholder="' . _lastName . '" class="form-control" id="last_name_input"></div></div>';
                ...
                echo '<div class="col-md-6">';
                $list = DBGet(DBQuery("SELECT DISTINCT TITLE,ID,SORT_ORDER FROM institute_gradelevels WHERE INSTITUTE_ID='" . UserInstitute() . "' ORDER BY SORT_ORDER"));
                echo '<div class="form-group"><label class="control-label text-right col-lg-4">' . _grade . '</label><div class="col-lg-8"><SELECT id="grade" class="form-control"><OPTION value="">' . _grade . '</OPTION>';
                ...
                // echo '<div class="form-group"><label class="control-label col-lg-4">'._section.'</label><div class="col-lg-8"><SELECT name=section class="form-control"><OPTION value="">'._section.'</OPTION>';
                // echo '</div><div class="col-md-6">';
                echo '<div class="form-group"><label class="control-label text-right col-lg-4">' . _section . '</label><div class="col-lg-8"><SELECT id="section" class="form-control"><OPTION value="">' . _section . '</OPTION>';
                ...
                case 'search_Fees':
                    echo '<div class="row">';
                    echo '<div class="col-md-6">';
                    echo '<div class="form-group"><label class="control-label text-right col-lg-4">' . _studentId . '</label><div class="col-lg-8"><input type=text id="stuid" size=30 placeholder="' . _studentId . '" class="form-control"></div></div>';    
                    echo '</div>'; //.col-md-6
                    echo '</div>'; //.row
                
                    echo '<div class="row">';
                    echo '<div class="col-md-6">';
                    echo '<div class="form-group"><label class="control-label text-right col-lg-4">' . _lastName . '</label><div class="col-lg-8"><input type=text id="last" size=30 placeholder="' . _lastName . '" class="form-control"></div></div>';
                    echo '</div><div class="col-md-6">';
                    echo '<div class="form-group"><label class="control-label text-right col-lg-4">' . _firstName . '</label><div class="col-lg-8"><input type=text id="first" size=30 placeholder="' . _firstName . '" class="form-control"></div></div>';
                    echo '</div>'; //.col-md-6
                    echo '</div>'; //.row
                    ...
                    case 'Search':
                        echo '<div class="row">';
                        echo '<div class="col-md-6">';
                        echo '<div class="form-group"><label class="control-label text-right col-lg-4">' . _studentId . '</label><div class="col-lg-8"><input type=text id="student_id" name="student_id" size=30 placeholder="' . _studentId . '" class="form-control"></div></div>';    
                        echo '</div>'; //.col-md-6
                        echo '</div>'; //.row
