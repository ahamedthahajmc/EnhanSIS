...
if (!$_REQUEST['modfunc']) {
    ...
    echo "<FORM action=ForExport.php?modname=" . strip_tags(trim($_REQUEST[modname])) . "&modfunc=save&include_inactive=" . strip_tags(trim($_REQUEST['include_inactive'])) . "&HaniIMS_PDF=true method=POST target=_blank>";
