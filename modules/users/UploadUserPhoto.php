...
' . $msg . '
<form enctype="multipart/form-data" action="Modules.php?modname=users/UploadUserPhoto.php&action=upload" method="POST">';
            echo '<div align=center>Select image file: <input name="file" type="file" accept="image/*" onchange="selectFile(this)"/><b><span >(Maximum upload file size 10 MB)</span></b><br /><br>';
