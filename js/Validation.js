function formcheck_institute_setup_institute(this_DET) {
  ...
  var institute_custom_req_ids = document.getElementById("custom_sch_field_ids").value;
  console.log(institute_custom_req_ids);
  if (institute_custom_req_ids != "") {
    var req_field_ids = institute_custom_req_ids.split(","); 
    var institute_custom_req_titles = document.getElementById("custom_sch_field_titles").value;
    var req_field_titles = institute_custom_req_titles.split(",");
  ...
  var institute_id = document.getElementById("h1").value;
...
function formcheck_institute_setup_portalnotes(this_DET) {
  var this_button_id = this_DET.id;
...
function formcheck_institute_setup_marking(this_DET) {
  var this_button_id = this_DET.id;
...
function formcheck_institute_setup_copyinstitute(this_DET) {
  var this_button_id = this_DET.id;
  ...
  frmvalidator.addValidation(
    "title",
    "req_copy_institute",
    "Please enter the new institute's title"
  );
  frmvalidator.addValidation(
    "title",
    "maxlen=100",
...
function formcheck_institute_specific_standards() {
...
function formcheck_institute_setup_calender(this_DET) {
  var this_button_id = this_DET.id;
  ...
  frmvalidator.setAddnlValidationFunction("ValidateDate_InstituteSetup_calender");
}

function ValidateDate_InstituteSetup_calender() {
...
function formcheck_staff_staff(staff_institute_chkbox_id) {
  ...
  return institute_check(staff_institute_chkbox_id);
}

function formcheck_institute_setup_periods_older(this_DET) {
  var this_button_id = this_DET.id;
...
function formcheck_institute_setup_periods(this_DET) {
  var this_button_id = this_DET.id;
...
function formcheck_institute_setup_grade_levels(this_DET) {
  var this_button_id = this_DET.id;
...
function formcheck_student_student(this_DET) {
  ...
  frmvalidator.addValidation(
    "students[FIRST_NAME]",
    "maxlen=100",
    "Max length for institute name is 100 characters"
  );
  ...
  frmvalidator.addValidation(
    "values[student_enrollment][new][NEXT_INSTITUTE]",
    "req",
...
function formcheck_user_user(staff_institute_chkbox_id) {
  var frmvalidator = new Validator("staff");
...
function institute_check(staff_institute_chkbox_id) {
  var chk = "n";
  var err = "T";
  if (staff_institute_chkbox_id) {
    for (i = 1; i <= staff_institute_chkbox_id; i++) {
      if (document.getElementById("staff_INSTITUTES" + i).checked == true) {
        chk = "y";
  ...
  if (chk != "y") {
    var d = $("divErr");
    err = "Please assign at least one institute to this staff.";
    d.innerHTML =
      '<div class="alert alert-danger no-border"><i class="fa fa-info-circle"></i>' +
      err +
      "</div>";
...
function formcheck_institutefields(this_DET) {
  var this_button_id = this_DET.id;
...
function formcheck_add_staff(staff_institute_chkbox_id, this_DET) {
  var this_button_id = this_DET.id;
  ...
  var end_date = document.getElementById("end_date_institute").value;
  ...
  if (current >= end) {
    document.getElementById("divErr").innerHTML =
      '<div class="alert alert-danger no-border"><i class="fa fa-info-circle"></i> Joining date can not be after institute\'s end date</div>';
    return false;
  }
  ...
  if (staff_institute_chkbox_id != 0 && staff_institute_chkbox_id != "")
    return institute_check(staff_institute_chkbox_id);
}
function formcheck_user_user_mod(staff_institute_chkbox_id = false, this_DET) {
  var this_button_id = this_DET.id;
...
function formcheck_institute_grad_config() {
...
function setFilterValues() {
  ...
  var ids1 = ["address_group", "_search_all_institutes", "include_inactive"];
